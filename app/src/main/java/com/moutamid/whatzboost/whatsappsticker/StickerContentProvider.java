...
public class StickerContentProvider extends ContentProvider {
    ...
    public static Uri AUTHORITYURI = new Uri.Builder().scheme("content").authority("com.moutamid.whatzboost.stickercontentprovider").appendPath("metadata").build();
    ...
    public boolean onCreate() {
        if ("com.moutamid.whatzboost.stickercontentprovider".startsWith(((Context) Objects.requireNonNull(getContext())).getPackageName())) {
            MATCHER.addURI("com.moutamid.whatzboost.stickercontentprovider", "metadata", 1);
            MATCHER.addURI("com.moutamid.whatzboost.stickercontentprovider", "metadata/*", 2);
            MATCHER.addURI("com.moutamid.whatzboost.stickercontentprovider", "stickers/*", 3);
            for (StickerPack next : getStickerPackList()) {
                UriMatcher uriMatcher = MATCHER;
                uriMatcher.addURI("com.moutamid.whatzboost.stickercontentprovider", "stickers_asset/" + next.identifier + "/" + next.trayImageFile, 5);
                for (Sticker sticker : next.getStickers()) {
                    UriMatcher uriMatcher2 = MATCHER;
                    uriMatcher2.addURI("com.moutamid.whatzboost.stickercontentprovider", "stickers_asset/" + next.identifier + "/" + sticker.imageFileName, 4);
                }
            }
            return true;
        }
