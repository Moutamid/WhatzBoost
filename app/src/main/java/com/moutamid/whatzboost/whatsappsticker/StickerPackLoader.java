...
public class StickerPackLoader {
    ...
    public static ArrayList<StickerPack> fetchStickerPacks(Context context) throws IllegalStateException {
        ...
        if (cursor == null) {
            throw new IllegalStateException("could not fetch from content provider, " + "com.moutamid.whatzboost.stickercontentprovider");
        }
    ...
    private static Uri getStickerListUri(String str) {
        return new Uri.Builder().scheme("content").authority("com.moutamid.whatzboost.stickercontentprovider").appendPath("stickers").appendPath(str).build();
    }

    public static Uri getStickerAssetUri(String str, String str2) {
        return new Uri.Builder().scheme("content").authority("com.moutamid.whatzboost.stickercontentprovider").appendPath("stickers_asset").appendPath(str).appendPath(str2).build();
    }
}
